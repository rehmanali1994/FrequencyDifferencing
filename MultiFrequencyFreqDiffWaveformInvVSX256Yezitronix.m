...
filename = 'VSX256_YezitronixPhantom22'; % 'VSX256_YezitronixPhantom44'
...
sos_perc_change_pre = 0.05; sos_perc_change_post = 0.05; 
...
fDATA = (0.75:0.05:4.0)*(1e6); % Extract these Frequencies from Data [Hz]
...
fDATA_SoS = (0.75:0.05:1.0)*(1e6); % Frequencies for SoS-only Iterations [Hz]
fDATA_SoSAtten = (0.775:0.05:1.025)*(1e6); % Frequencies for SoS/Attenuation Iterations [Hz]
...
for f_idx = 1:numel(fDATA)
    ...
    for iter_f_idx = 1:(niterSoSPerFreq(f_idx)+niterAttenPerFreq(f_idx))
        ...
        perc_step_size = 1/2; % (<1/2) Introduced to Improve Compliance with Strong Wolfe Conditions 
