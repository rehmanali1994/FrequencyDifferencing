...
filename = 'VSX256_MacaqueBrain_HF_1_24_24_Slice02'; % 'VSX256_MacaqueBrain_HF_1_24_24_Slice03'
...
sos_perc_change_pre = 0.05; sos_perc_change_post = 0.05; %Inf; 
...
fDIFF = (0.1:0.05:0.9)*(1e6); % Synthesize these Frequencies [Hz]
...
fDATA_SoS = (0.55:0.05:1.0)*(1e6); % Frequencies for SoS-only Iterations [Hz]
fDATA_SoSAtten = (0.575:0.05:1.025)*(1e6); % Frequencies for SoS/Attenuation Iterations [Hz]
...
crange = [1440, 1600]; % For reconstruction display [m/s]
